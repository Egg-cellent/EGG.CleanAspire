...
using EGG.CleanAspire.Infrastructure;
using FluentAssertions;
using NetArchTest.Rules;

namespace EGG.CleanAspire.Architecture.Tests;
...
public sealed class ArchitectureTests
{
    ...
    private const string DomainNamespace = "EGG.CleanAspire.Domain";
    private const string ApplicationNamespace = "EGG.CleanAspire.Application";
    private const string InfrastructureNamespace = "EGG.CleanAspire.Infrastructure";
    private const string ApiNamespace = "EGG.CleanAspire.Api";
    ...
    public void Domain_Entities_Should_Not_Be_Public_Setters_For_Id()
    {
        var result = Types.InAssembly(DomainAssembly)
            .That()
            .ResideInNamespace("EGG.CleanAspire.Domain.Entities")
            .Should()
            .BeSealed()
            .GetResult();
