...
try
{
    ...
    builder.AddRedisDistributedCache("egg-cache");
    ...
    builder.Services.AddOpenApi(options =>
    {
        options.AddDocumentTransformer((document, _, _) =>
        {
            ...
            info.Title = "Clean Architecture API";
            info.Description = "A Clean Architecture template for .NET 10";
            info.Contact = new Microsoft.OpenApi.OpenApiContact
            {
                Name = "EGG",
                Url = new Uri("https://localhost:7200"),
            };
            document.Info = info;
    ...
    if (app.Environment.IsDevelopment())
    {
        ...
        {
            options.WithTitle("EGG Clean Architecture API");
